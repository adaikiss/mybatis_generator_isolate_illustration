...
/**
 * modified from {@link org.apache.ibatis.builder.annotation.MapperAnnotationBuilder}
 * 
 * @author hlw
 * 
 */
public class IsolateMapperAnnotationBuilder extends MapperAnnotationBuilder {
	...
	public IsolateMapperAnnotationBuilder(Configuration configuration, Class<?> type) {
	...
	private void loadXmlResource() {
		...
		if (!configuration.isResourceLoaded("namespace:" + type.getName())) {
			...
			if (inputStream != null) {
				// <!-- modified
				IsolateXMLMapperBuilder xmlParser = new IsolateXMLMapperBuilder(inputStream,
	...
	private Discriminator applyDiscriminator(String resultMapId, Class<?> resultType, TypeDiscriminator discriminator) {
		if (discriminator != null) {
			...
			Discriminator discr = assistant.buildDiscriminator(resultType, column, javaType, jdbcType, typeHandler, discriminatorMap);
			try {
	...
	void _parseStatement(Method method) {
	...
	private void applyConstructorArgs(Arg[] args, Class<?> resultType, List<ResultMapping> resultMappings) {
		for (Arg arg : args) {
			...
			ResultMapping resultMapping = assistant.buildResultMapping(resultType, null, nullOrEmpty(arg.column()), arg
					...
					: arg.jdbcType(), nullOrEmpty(arg.select()), nullOrEmpty(arg.resultMap()), null, null, arg
					.typeHandler() == UnknownTypeHandler.class ? null : arg.typeHandler(), flags, null, null, false);
			resultMappings.add(resultMapping);
		}
	}
